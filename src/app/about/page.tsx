  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-50">
      <section className="mx-auto flex max-w-5xl flex-col gap-10 px-6 pt-28 pb-16 md:flex-row md:items-start">
        ...
        {/* Right column: stats / highlights card */}
        <div className="w-full md:w-1/2">
          <div className="rounded-3xl bg-gradient-to-br from-blue-600/20 via-blue-400/10 to-sky-400/10 border border-neutral-800 p-6 md:p-8 shadow-[0_0_40px_rgba(37,99,235,0.25)]">
